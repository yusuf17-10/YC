class TimeTable{
    constructor(){  
        this.input1 = createInput(user.answer[0]);
        this.submit=createButton("submit");
        this.input2 = createInput(user.answer[1]);
        this.input3 = createInput(user.answer[2]);
        this.input4 = createInput(user.answer[3]);
        this.input5 = createInput(user.answer[4]);
        this.input6 = createInput(user.answer[5]);
        this.input7 = createInput(user.answer[6]); 
        this.input8  = createInput(user.answer[7]);
        this.input9  = createInput(user.answer[8]);
        this.input10 = createInput(user.answer[9]);
        this.input11 = createInput(user.answer[10]);
        this.input12 = createInput(user.answer[11]);
        this.input13 = createInput(user.answer[12]);
        this.input14 = createInput(user.answer[13]);
        this.input15 = createInput(user.answer[14]);
        this.input16 = createInput(user.answer[15]);
        this.input17 = createInput(user.answer[16]);
        this.input18 = createInput(user.answer[17]);
        this.input19 = createInput(user.answer[18]);
        this.input20 = createInput(user.answer[19]);
        this.input21= createInput(user.answer[20]);
        this.input22 = createInput(user.answer[21]);
        this.input23 = createInput(user.answer[22]);
        this.input24 = createInput(user.answer[23]);
        this.input25 = createInput(user.answer[24]);
        this.input26 = createInput(user.answer[25]); 
        this.input27 = createInput(user.answer[26]);
        this.input28 = createInput(user.answer[27]);
        this.input29 = createInput(user.answer[28]);
        this.input30 = createInput(user.answer[29]);
        this.input31 = createInput(user.answer[30]);
        this.input32 = createInput(user.answer[31]);
        this.input33= createInput(user.answer[32]);
        this.input34 = createInput(user.answer[33]);
        this.input35 = createInput(user.answer[34]);
        this.input36 = createInput(user.answer[35]);
        this.input37 = createInput(user.answer[36]);
        this.input38 = createInput(user.answer[37]);
        this.input39 = createInput(user.answer[38]);
        this.input40 = createInput(user.answer[39]);
        this.input41 = createInput(user.answer[40]);
        this.input42 = createInput(user.answer[41]); 
        this.input43 = createInput(user.answer[42]);
        this.input44 = createInput(user.answer[43]);
        this.input45 = createInput(user.answer[44]);
        this.input46 = createInput(user.answer[45]);
        this.input47 = createInput(user.answer[46]);
        this.input48 = createInput(user.answer[47]);
        this.input49 = createInput(user.answer[48]);
        this.input50 = createInput(user.answer[49]);
        this.input51 = createInput(user.answer[50]);
        this.input52 = createInput(user.answer[51]);
        this.input53 = createInput(user.answer[52]);
        this.input54 = createInput(user.answer[53]);
        this.input55 = createInput(user.answer[54]);
        this.input56 = createInput(user.answer[55]);
        this.input57 = createInput(user.answer[56]);
        this.input58 = createInput(user.answer[57]);
        this.input59 = createInput(user.answer[58]);
        this.input60 = createInput(user.answer[59]);
        this.input61 = createInput(user.answer[60]); 
        this.input62 = createInput(user.answer[61]);
        this.input63 = createInput(user.answer[62]);
        this.input64 = createInput(user.answer[63]);
        this.input65 = createInput(user.answer[64]);
        this.input66 = createInput(user.answer[65]);
        this.input67 = createInput(user.answer[66]);
        this.input68 = createInput(user.answer[67]);
        this.input69 = createInput(user.answer[68]);
        this.input70 = createInput(user.answer[69]);
       
        

        
        this.time1=createInput(user.time[0]);
        this.time2=createInput(user.time[1]);
        this.time3=createInput(user.time[2]);
        this.time4=createInput(user.time[3]);
        this.time5=createInput(user.time[4]);
        this.time6=createInput(user.time[5]);
        this.time7=createInput(user.time[6]);
        this.time8=createInput(user.time[7]);
        this.time9=createInput(user.time[8]);
        this.time10=createInput(user.time[9]);
